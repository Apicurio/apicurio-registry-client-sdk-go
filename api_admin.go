...
func (r AdminApiApiExportDataRequest) Execute() (interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return interface{}
func (a *AdminApiService) ExportDataExecute(r AdminApiApiExportDataRequest) (interface{}, *http.Response, error) {
	var (
