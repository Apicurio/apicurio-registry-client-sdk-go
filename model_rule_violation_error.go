...
type _RuleViolationError RuleViolationError
...
func (o *RuleViolationError) UnmarshalJSON(bytes []byte) (err error) {
	...
	varRuleViolationError := _RuleViolationError{}

	err = json.Unmarshal(bytes, &varRuleViolationError)

	if err != nil {
		return err
	}

	*o = RuleViolationError(varRuleViolationError)
