...
// checks if the RuleViolationErrorAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleViolationErrorAllOf{}
...
func (o RuleViolationErrorAllOf) ToMap() (map[string]interface{}, error) {
