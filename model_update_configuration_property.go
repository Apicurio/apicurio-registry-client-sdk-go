...
// checks if the UpdateConfigurationProperty type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateConfigurationProperty{}
...
type _UpdateConfigurationProperty UpdateConfigurationProperty
...
func (o UpdateConfigurationProperty) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["value"] = o.Value
	return toSerialize, nil
}

func (o *UpdateConfigurationProperty) UnmarshalJSON(bytes []byte) (err error) {
	...
	varUpdateConfigurationProperty := _UpdateConfigurationProperty{}

	err = json.Unmarshal(bytes, &varUpdateConfigurationProperty)

	if err != nil {
		return err
	}

	*o = UpdateConfigurationProperty(varUpdateConfigurationProperty)
