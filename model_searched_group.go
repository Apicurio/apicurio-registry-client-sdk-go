...
type _SearchedGroup SearchedGroup
...
func (o *SearchedGroup) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSearchedGroup := _SearchedGroup{}

	err = json.Unmarshal(bytes, &varSearchedGroup)

	if err != nil {
		return err
	}

	*o = SearchedGroup(varSearchedGroup)
