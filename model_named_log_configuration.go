...
// checks if the NamedLogConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NamedLogConfiguration{}
...
func (o NamedLogConfiguration) ToMap() (map[string]interface{}, error) {
