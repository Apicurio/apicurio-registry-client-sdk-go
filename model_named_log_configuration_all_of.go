...
// checks if the NamedLogConfigurationAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NamedLogConfigurationAllOf{}
...
func (o NamedLogConfigurationAllOf) ToMap() (map[string]interface{}, error) {
