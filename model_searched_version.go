...
type _SearchedVersion SearchedVersion
...
func (o *SearchedVersion) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSearchedVersion := _SearchedVersion{}

	err = json.Unmarshal(bytes, &varSearchedVersion)

	if err != nil {
		return err
	}

	*o = SearchedVersion(varSearchedVersion)
