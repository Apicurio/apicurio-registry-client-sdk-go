...
func (o *DownloadRef) UnmarshalJSON(bytes []byte) (err error) {
	...
	varDownloadRef := _DownloadRef{}

	err = json.Unmarshal(bytes, &varDownloadRef)

	if err != nil {
		return err
	}

	*o = DownloadRef(varDownloadRef)
