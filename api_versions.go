...
func (r VersionsApiApiCreateArtifactVersionRequest) Body(body interface{}) VersionsApiApiCreateArtifactVersionRequest {
	r.body = &body
	return r
}
...
func (r VersionsApiApiGetArtifactVersionRequest) Execute() (interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return interface{}
func (a *VersionsApiService) GetArtifactVersionExecute(r VersionsApiApiGetArtifactVersionRequest) (interface{}, *http.Response, error) {
	var (
