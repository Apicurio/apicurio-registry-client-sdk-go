...
// checks if the ArtifactSearchResults type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ArtifactSearchResults{}
...
type _ArtifactSearchResults ArtifactSearchResults
...
func (o ArtifactSearchResults) ToMap() (map[string]interface{}, error) {
...
func (o *ArtifactSearchResults) UnmarshalJSON(bytes []byte) (err error) {
	...
	varArtifactSearchResults := _ArtifactSearchResults{}

	err = json.Unmarshal(bytes, &varArtifactSearchResults)

	if err != nil {
		return err
	}

	*o = ArtifactSearchResults(varArtifactSearchResults)
