...
type _SearchedArtifact SearchedArtifact
...
func (o *SearchedArtifact) UnmarshalJSON(bytes []byte) (err error) {
	...
	varSearchedArtifact := _SearchedArtifact{}

	err = json.Unmarshal(bytes, &varSearchedArtifact)

	if err != nil {
		return err
	}

	*o = SearchedArtifact(varSearchedArtifact)
